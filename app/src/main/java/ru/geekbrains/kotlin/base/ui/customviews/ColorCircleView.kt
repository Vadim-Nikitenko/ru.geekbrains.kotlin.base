package ru.geekbrains.kotlin.base.ui.customviews
...
import ru.geekbrains.kotlin.base.common.dip

//JvmOverloads делает стандартные перегрузки конструкторов для кастомной вьюхи
class ColorCircleView @JvmOverloads constructor(
    ...
    init {
        ...
        strokeColorRes =
            a.getResourceId(R.styleable.ColorCircleView_strokeColor, R.color.text_secondary)
        a.recycle()
    }
